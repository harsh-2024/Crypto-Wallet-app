...
TextEditingController myControllersol = TextEditingController();
...
class _SOLState extends State<SOL> {
  ...
  Future<void> updateSOL() async {
    mapdata["walletAmount"] -= int.parse(myControllersol.text);
    mapdata["solAmount"] += int.parse(myControllersol.text);
